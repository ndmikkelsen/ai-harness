...
- Current focus: workflow UX improvements are landed, including interactive-first operator guidance, feature-branch-only landing, executable Muninn-style BDD coverage, and a managed `/gsd-autonomous` override for OpenCode installs.
- Current branch: `dev`
